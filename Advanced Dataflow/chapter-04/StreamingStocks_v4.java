...
public class StreamingStocks {
    ...
    public interface PubSubReadOptions extends StreamingOptions {
        ...
        @Description("Output file's slide window size in number of seconds.")
        @Default.Integer(60)
        Integer getSlideWindowSize();
        void setSlideWindowSize(Integer value);
    ...
    private static void streamingStockData(PubSubReadOptions options) {
        ...
        pubSubMessages.apply("ApplyWindow", Window.<String>into(SlidingWindows
                .of(Duration.standardSeconds(options.getWindowSize()))
                .every(Duration.standardSeconds(options.getSlideWindowSize())))
    ...
    public static class Average extends DoFn<KV<String, Iterable<Double>>, KV<String, Double>> {
        ...
        public void processElement(DoFn<KV<String, Iterable<Double>>, KV<String, Double>>.ProcessContext c) {
            ...
            Double average = Math.round(100.0 * total / n) / 100.0;
